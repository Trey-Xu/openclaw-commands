...
- **Agent 自动化**：Skill 三件套（`SKILL.md` / `reference.md` / `troubleshooting.md`）；sync-only / release 模式
- **脚本**：`detect-upstream-drift`、`bump-openclaw-version`、`update-bundled-release`；drift 工作流自动开 `openclaw-sync` Issue

### Changed

- **OpenClaw 版本**: 跟踪至 [v2026.5.22](https://github.com/openclaw/openclaw/releases/tag/v2026.5.22)
- **命令参考**: 顶层 CLI 与官方 v2026.5.22 对齐（55 命令）；离线 Release Notes 已更新
